...
// icon fallback when the folder has no images) + name + item count.
export function FolderCard({ folder }: { folder: FolderWithMeta }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-lg border border-border bg-card transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
